...
public class EntityManager<E> implements DbContext<E> {
    ...
    private boolean ifTableExists() throws SQLException {
        ...
        String query = String.format("SELECT TABLE_NAME\n" +
                ...
                "AND TABLE_NAME = %s;", this.getTableName(User.class));
    ...
    public void createTable() {
        String query = "CREATE TABLE " + this.getTableName(User.class) + "(";
        Field idField = this.getId(User.class);
        String[] fields = this.getTableFields((E) User.class);
